  ...
  <header id="header">
    ...
    <div class="user">
      <div class="user-info">
        ...
        <span id="userHierarchy">사원</span>
      </div>
      <div class="user-service">
        <ul>
          <!-- 아이디 동일 * 확인 요망 * -->
          <li><i class="ic-mail icon"></i><span>메일</span><a href="#" id="linkMail">8</a></li>
          <li><a href="#" id="linkMail">내 정보 관리</a></li>
        </ul>
      </div>
      <div class="btn-wrap">
        <button id="logout">로그아웃<i class="ic-logout icon"></i></button>
        <button id="videoConference"><span class="btn-detail">화상회의</span></button>
        <button id="reservation"><span class="btn-detail">예약</span></button>
      </div>
    </div>
  </header>
  <nav id="nav">
